...
def knapsack_bruteforce_combinations(values, weights, capacity):
    """
    Brute-force 0/1 Knapsack using manually generated combinations.
    - Tries all possible subsets of items.
    - Keeps the subset with maximum total value within capacity.
    """
    n = len(values)
    best_value = 0
    best_items = []
